...
/* internal */
#define DM9058_NCR   (0x00)
#define DM9058_NSR   (0x01)
#define DM9058_TCR   (0x02)
#define DM9058_TSR1  (0x03)
#define DM9058_TSR2  (0x04)
#define DM9058_RCR   (0x05)
#define DM9058_RSR   (0x06)
#define DM9058_ROCR  (0x07)
#define DM9058_BPTR  (0x08)
#define DM9058_FCTR  (0x09)
#define DM9058_FCR   (0x0A)
#define DM9058_EPCR  (0x0B)
#define DM9058_EPAR  (0x0C)
#define DM9058_EPDRL (0x0D)
#define DM9058_EPDRH (0x0E)
#define DM9058_WCR   (0x0F)

#define DM9058_PAR (0x10)
#define DM9058_MAR (0x16)

#define DM9058_GPCR  (0x1e)
#define DM9058_GPR   (0x1f)
#define DM9058_TRPAL (0x22)
#define DM9058_TRPAH (0x23)
#define DM9058_RWPAL (0x24)
#define DM9058_RWPAH (0x25)

#define DM9058_VIDL (0x28)
#define DM9058_VIDH (0x29)
#define DM9058_PIDL (0x2A)
#define DM9058_PIDH (0x2B)

#define DM9058_CHIPR (0x2C)
#define DM9058_TCR2  (0x2D)
#define DM9058_OTCR  (0x2E)
#define DM9058_SMCR  (0x2F)

#define DM9058_ATCR  (0x30) /* early transmit control/status register */
#define DM9058_CSCR  (0x31) /* check sum control register */
#define DM9058_RCSSR (0x32) /* receive check sum status register */

#define DM9058_PBCR   (0x38)
#define DM9058_INTR   (0x39)
#define DM9058_TXFSSR (0x3B)
#define DM9058_PPCR   (0x3D)
#define DM9058_IPCOCR (0x54)
#define DM9058_MPCR   (0x55)
#define DM9058_LMCR   (0x57)
#define DM9058_MBNDRY (0x5E)
#define DM9058_MRCMDX (0x70)
// #define DM9058_MRCMD              (0x72)
#define DM9058_MRRL   (0x74)
#define DM9058_MRRH   (0x75)
#define DM9058_MWCMDX (0x76)
// #define DM9058_MWCMD              (0x78)
#define DM9058_MWRL   (0x7A)
#define DM9058_MWRH   (0x7B)
#define DM9058_TXPLL  (0x7C)
#define DM9058_TXPLH  (0x7D)
#define DM9058_ISR    (0x7E)
#define DM9058_IMR    (0x7F)
...
#define CHIPR_DM9058A (0x19)
#define CHIPR_DM9058B (0x1B)

#define DM9058_NCR_RESET (0x01)
#define DM9058_IMR_OFF   (0x80)
#define DM9058_TCR2_SET  (0x90) /* set one packet */
#define DM9058_RCR_SET   (0x31)
#define DM9058_BPTR_SET  (0x37)
#define DM9058_FCTR_SET  (0x38)
#define DM9058_FCR_SET   (0x28)
// #define DM9058_TCR_SET        (0x01)
...
/* 0x31 */
// #define _DM9058_CSCR         (0x31)            /* check sum control register */
#define TCSCR_UDPCS_ENABLE (1 << 2)
#define TCSCR_TCPCS_ENABLE (1 << 1)
#define TCSCR_IPCS_ENABLE  (1 << 0)

/* 0x32 */
// #define _DM9058_RCSSR        (0x32)            /* receive check sum status register */
...
struct dm9058_runtime {
	struct net_if *iface;
	struct k_sem tx_rx_sem;
	struct k_sem int_sem;

	K_KERNEL_STACK_MEMBER(thread_stack, CONFIG_ETH_DM9058_RX_THREAD_STACK_SIZE);
